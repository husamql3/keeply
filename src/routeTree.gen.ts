...
import { Route as ApiJoinWishlistRouteImport } from './routes/api/join-wishlist'
...
const ApiJoinWishlistRoute = ApiJoinWishlistRouteImport.update({
  id: '/api/join-wishlist',
  path: '/api/join-wishlist',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/join-wishlist': {
      id: '/api/join-wishlist'
      path: '/api/join-wishlist'
      fullPath: '/api/join-wishlist'
      preLoaderRoute: typeof ApiJoinWishlistRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/_pathlessLayout/_nested-layout': {
